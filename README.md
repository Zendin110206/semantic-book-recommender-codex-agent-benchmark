...
This repository was created purely as an experimental exercise to explore the workflow of building a software project with an AI coding agent.

In this project, the **codebase, project structure, and most implementation details were generated by an AI agent**. My role was primarily to guide the process by providing prompts, defining the project goals, reviewing outputs, and iterating on the instructions given to the agent.

The purpose of this repository is simply to test whether an AI agent can successfully construct a functional project under human direction.

Because the implementation itself was produced by the AI agent, **this project is not intended to represent my personal coding ability and is not meant to be included as part of a professional portfolio**. It should instead be viewed as a learning experiment and a technical exploration of AI-assisted development workflows.
